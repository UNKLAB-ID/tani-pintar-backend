...
LOGIN_CODE_DISCORD_WEBHOOK_URL = env(
    "LOGIN_CODE_DISCORD_WEBHOOK_URL",
    default="",
)

# Vendors
VENDORS_NOTIFICATION_DISCORD_WEBHOOK_URL = env(
    "VENDORS_NOTIFICATION_DISCORD_WEBHOOK_URL",
    default="",
)
...
OPENAI_MODERATION_API_KEY = env("OPENAI_MODERATION_API_KEY", default="")
